...
export function HeroBadge({ className }: HeroBadgeProps) {
  return (
    <div
      className={`inline-flex items-center gap-2 rounded-full bg-background/20 border border-background/10 backdrop-blur-sm px-4 py-2 ${className}`}
    >
      ...
      <span className='text-sm text-foreground/60 tracking-tight'>
        Introducing Scia - Phase 1 Development
      </span>
    </div>
  );
}
