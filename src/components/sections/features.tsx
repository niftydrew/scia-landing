...
const FeatureCard = ({
  ...
  <motion.div
    ...
    className={colSpan}
  >
    <div className={`flex flex-col overflow-hidden rounded-lg bg-background ring-1 ring-accent/10 ${className}`}>
...
export function Features() {
  return (
    <div id='features' className='py-24 sm:py-32 gradient-dark'>
