...
const FeatureCard = ({
  ...
  >
    <div
      className={`flex flex-col overflow-hidden rounded-lg bg-accent/10 ring-1 ring-accent/20 shadow-[inset_0_0_30px_rgba(165,180,252,0.1)] ${className}`}
    >
...
const features = [
  ...
  },
  {
    ...
    splineScene: 'https://prod.spline.design/mzr5CXkCStGOXV0u/scene.splinecode',
...
export function Features() {
  return (
    <section className='relative py-20'>
      ...
      >
        <div className='mx-auto max-w-[1024px] w-[95%] sm:w-[90%] relative'>
